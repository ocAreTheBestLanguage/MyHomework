...
- (void)ViewAddTo:(UIViewController *)viewController andTitle:(NSString *)title{
    ...
    //添加观察者
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(notifyTextFieldDidChang) name:UITextFieldTextDidChangeNotification object:registerView.userName];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(notifyTextFieldDidChang) name:UITextFieldTextDidChangeNotification object:registerView.passWord];
    if ([title isEqualToString:@"注册"]){ [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(notifyTextFieldDidChang) name:UITextFieldTextDidChangeNotification object:registerView.passWordAg]; }
}
- (void)notifySwipeUp{
