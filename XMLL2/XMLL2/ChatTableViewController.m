...
//  XMLL2
//
//  Created by zzddn on 2017/1/25.
//  Copyright © 2017年 zzddn. All rights reserved.
//

#import "ChatTableViewController.h"
#import "XMPPStreamManager.h"
@interface ChatTableViewController ()<XMPPStreamManagerDelegate>
...
- (void)didReceiveMessage:(XMPPStreamManager *)sender andChatMessage:(NSString *)chatMessage{
    NSLog(@"%@",chatMessage);
    [self.arr addObject:chatMessage];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil){
        cell = [[UITableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"chat"];
    }
